...
namespace Horoskop
{
    ...
    {
        DateTime _changeTime; // переменная для хранения выбранной даты
        public MainPage()
        {
        ...
        {
            _changeTime = dp.Date; // присваиваем переменной значение выбранной даты
                                   // проверяем месяц выбранной даты и выводим соответствующую информацию об знаке зодиака
            ...
            // Продолжайте добавлять условия для других месяцев и соответствующую информацию о знаках зодиака
